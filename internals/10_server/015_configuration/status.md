...
Claim anchors: [`AsgiConfigBuilder`](../../../src/genro_asgi/config/builder.py#L60), [`AsgiServerGrammar`](../../../src/genro_asgi/config/elements.py#L82), [`AsgiServer`](../../../src/genro_asgi/asgi_server.py#L91), [`BaseConfiguration`](../../../src/genro_asgi/config/builder.py#L75), [`server_section`](../../../src/genro_asgi/config/builder.py#L107), [`storage_mounts`](../../../src/genro_asgi/config/builder.py#L121), [`DefaultConfig`](../../../src/genro_asgi/config/default_config.py#L64), [`parents_for`](../../../src/genro_asgi/config/default_config.py#L75), [`ConfigError`](../../../src/genro_asgi/config/handler.py#L65), [`ConfigurationHandler`](../../../src/genro_asgi/config/handler.py#L69).
...
Claim anchors: [`SpaApplication`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L517), [`GroupPolicy`](../../../src/genro_asgi_multiworker_spa/orchestration/group_policy.py#L70), [`SpaCommander`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L494), [`apply_group_settings`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L1448).

## Source and test evidence

- [src/genro_asgi/config/builder.py](../../../src/genro_asgi/config/builder.py)
- [src/genro_asgi/config/default_config.py](../../../src/genro_asgi/config/default_config.py)
- [src/genro_asgi/config/elements.py](../../../src/genro_asgi/config/elements.py)
- [src/genro_asgi/config/handler.py](../../../src/genro_asgi/config/handler.py)
