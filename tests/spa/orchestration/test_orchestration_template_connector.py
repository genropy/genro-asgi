...
from genro_asgi_multiworker_spa.orchestration import ForkedProcess, WorkerHandler
from genro_asgi_multiworker_spa.orchestration.template_connector import (
    TemplateConnector,
    TemplateRefused,
)
...
FACTORY = "tests.spa.orchestration.engine_stub:EngineFactory"
BROKEN_FACTORY = "tests.spa.orchestration.engine_stub:BrokenFactory"
ENGINE_WORKER = "tests.spa.orchestration.engine_stub:EngineWorker"
...
async def test_a_build_that_prints_cannot_dirty_the_answer_channel(
    ...
    connector = TemplateConnector(
        group,
        engine_factory="tests.spa.orchestration.engine_stub:NoisyFactory",
