...
[015 configuration](../015_configuration/README.md) §2 promises the opposite shape for
capabilities generally. Recorded in the same wording in
[015 configuration](../015_configuration/decisions.md) S6 and
[025 routing system](../025_routing-system/decisions.md) S3.
...
same wording in [020 applications](../020_applications/decisions.md).
