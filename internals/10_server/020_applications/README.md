...
> [015 configuration](../015_configuration/); the monitor and its panels are
> [090 server-application](../090_server-application/); when a change is taken
> on and what follows is
> [015 configuration](../015_configuration/) again.
