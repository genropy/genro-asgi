...
The grammar is the core's (``genro_asgi/config/handler.py``): ``orchestration``
...
from genro_asgi import AsgiConfigBuilder, AsgiServer, ConfigurationHandler
from genro_asgi_multiworker_spa.orchestration import GroupHandler, SpaCommander
...
from tests.core.test_config import TwoAppConfig
...
class SpaPoolConfig(AsgiConfigBuilder):
    ...
    def commander_section(self, front: Any) -> None:
        ...
        groups.group(name="canary", entry_module="genro_asgi_multiworker_spa.orchestration.worker_entry")
...
class ElectedGroupConfig(SpaPoolConfig):
    ...
    def commander_section(self, front: Any) -> None:
        ...
        groups.group(name="stable", entry_module="genro_asgi_multiworker_spa.orchestration.worker_entry")
        groups.group(name="canary", entry_module="genro_asgi_multiworker_spa.orchestration.worker_entry")
