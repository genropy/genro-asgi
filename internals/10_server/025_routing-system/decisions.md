...
The consequence for [020 applications](../020_applications/README.md) is deliberate.
...
[020 applications](../020_applications/README.md) makes about its several protocols.
...
[015 configuration](../015_configuration/README.md) §2, which says a new capability
...
[020 applications](../020_applications/README.md) §2 and here, and nothing states the
...
- **where the essentials of routing live.** They live here: this entry was
  ...
  in [020 applications](../020_applications/README.md) is settled the same way — that
