...
- Root data path (through the root vs resolve-and-forward) undecided; directory persistence, lease/fencing protocol and failure model still to be ratified.
