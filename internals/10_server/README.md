...
description an installation is assembled from, and the capability layers stacked
...
| [020 applications](020_applications/README.md) | `RoutedApplication` and the route tree · [openapi](020_applications/openapi/README.md) · [mcp](020_applications/mcp/README.md) |
...
| [030 middleware](030_middleware/README.md) | the uniform ring every request passes |
...
| [060 storage](060_storage/README.md) | the only door to the filesystem |
