...
from genro_asgi_multiworker_spa.orchestration.group_policy import GroupPolicyError
from genro_asgi_multiworker_spa.orchestration.spa_commander import SingleGroupRequired
...
async def test_boot_failure_invalid_profile(tmp_path, caplog):
    ...
    with caplog.at_level(logging.ERROR, logger="genro_asgi_multiworker_spa.spa_app"):
