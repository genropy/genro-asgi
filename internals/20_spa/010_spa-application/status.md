...
`SpaApplication` lives in `genro_asgi_multiworker_spa.spa_app`. It reads its
...
Claim anchors: [`SpaApplication`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L517), [`SpaApplicationGrammar`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L152), [`internal_roots`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L612), [`resolves_natively`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L622), [`WsxControl`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L454), [`openchannel`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L471), [`openchannel`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_worker.py#L507).
...
Claim anchors: [`pack_http`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L1163), [`SpaCommander`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L494), [`serve_request`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L691).
...
Claim anchors: [`handshake_cookie`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L524), [`openchannel`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L471), [`openchannel`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_worker.py#L507), [`build_response`](../../../src/genro_asgi_multiworker_spa/spa_app.py#L1122).
