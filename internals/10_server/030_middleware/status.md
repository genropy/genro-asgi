...
Claim anchors: [`SessionMiddleware`](../../../src/genro_asgi/middleware/session.py#L55), [`AuthMiddleware`](../../../src/genro_asgi/middleware/authentication.py#L39).

Behavior evidence: [`CORSMiddleware`](../../../src/genro_asgi/middleware/cors.py#L43), [`LoggingMiddleware`](../../../src/genro_asgi/middleware/logging.py#L37).
...
Claim anchors: [`WsxConnection`](../../../src/genro_asgi/wsx.py#L193), [`get_middleware`](../../../src/genro_asgi/middleware/__init__.py#L103), [`SessionMiddleware`](../../../src/genro_asgi/middleware/session.py#L55), [`get_session`](../../../src/genro_asgi/middleware/session.py#L80).

## Source and test evidence

- [src/genro_asgi/middleware/__init__.py](../../../src/genro_asgi/middleware/__init__.py)
- [src/genro_asgi/middleware/base.py](../../../src/genro_asgi/middleware/base.py)
- [src/genro_asgi/middleware/errors.py](../../../src/genro_asgi/middleware/errors.py)
- [src/genro_asgi/middleware/cors.py](../../../src/genro_asgi/middleware/cors.py)
