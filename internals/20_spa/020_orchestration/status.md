...
application. This package is `genro_asgi_multiworker_spa`, distinct from the
...
Claim anchors: [`SpaCommander`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L494), [`GroupHandler`](../../../src/genro_asgi_multiworker_spa/orchestration/group_handler.py#L320), [`WorkerHandler`](../../../src/genro_asgi_multiworker_spa/orchestration/worker_handler.py#L209), [`SpaWorker`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_worker.py#L564), [`WorkerEntry`](../../../src/genro_asgi_multiworker_spa/orchestration/worker_entry.py#L90).
...
Claim anchors: [`resolve_worker`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L753), [`worker_events`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_worker.py#L782), [`freeze_hosted_user`](../../../src/genro_asgi_multiworker_spa/orchestration/group_handler.py#L990), [`FreezeHandler`](../../../src/genro_asgi_multiworker_spa/orchestration/freeze_handler.py#L88).
...
Claim anchors: [`GroupPolicy`](../../../src/genro_asgi_multiworker_spa/orchestration/group_policy.py#L70), [`apply_group_settings`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L1448).
...
Claim anchors: [`quit`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_worker.py#L445), [`quit`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L1710), [`quit`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_worker.py#L2088).
...
- [src/genro_asgi_multiworker_spa/orchestration/group_policy.py](../../../src/genro_asgi_multiworker_spa/orchestration/group_policy.py)
- [src/genro_asgi_multiworker_spa/orchestration/worker_handler.py](../../../src/genro_asgi_multiworker_spa/orchestration/worker_handler.py)
- [src/genro_asgi_multiworker_spa/orchestration/worker_entry.py](../../../src/genro_asgi_multiworker_spa/orchestration/worker_entry.py)
- [src/genro_asgi_multiworker_spa/orchestration/template_entry.py](../../../src/genro_asgi_multiworker_spa/orchestration/template_entry.py)
