...
async def test_the_change_batch_machinery_is_gone():
    ...
    from genro_asgi_multiworker_spa import global_store as global_store_module
    from genro_asgi_multiworker_spa.orchestration import SpaCommander, spa_commander
