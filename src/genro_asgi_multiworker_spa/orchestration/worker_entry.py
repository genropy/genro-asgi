...
``python -m genro_asgi_multiworker_spa.orchestration.worker_entry`` is what a WorkerHandler
...
the handler writes::
    ...
    {"name": "standard_0001",
     ...
     "worker_class": "genro_asgi_multiworker_spa.orchestration.spa_worker:SpaWorker",
...
DEFAULT_WORKER_CLASS = "genro_asgi_multiworker_spa.orchestration.spa_worker:SpaWorker"
...
def main() -> int:
    """``python -m genro_asgi_multiworker_spa.orchestration.worker_entry``: the spawn shell."""
