...
from genro_asgi import AsgiConfigBuilder, AsgiServer, BaseApplication
from genro_asgi import wsx as wsx_module
from genro_asgi import wsx_payload as wsx_payload_module
    ...
    class FrontConfiguration(AsgiConfigBuilder):
        ...
        def main(self, root: Any) -> None:
            ...
            commander.groups(default="opaque").group(
                ...
                worker_class="tests.core.opaque_spa_worker:OpaqueSpaWorker",
