...
Claim anchors: [`SpaCommander`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L494), [`new_global_store`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L977), [`GlobalStoreLock`](../../../src/genro_asgi_multiworker_spa/global_store.py#L110), [`GlobalStoreOperations`](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py#L280), [`GlobalStoreClient`](../../../src/genro_asgi_multiworker_spa/global_store.py#L154), [`for_update`](../../../src/genro_asgi_multiworker_spa/global_store.py#L201), [`GlobalStoreLease`](../../../src/genro_asgi_multiworker_spa/global_store.py#L206), [`abort`](../../../src/genro_asgi_multiworker_spa/global_store.py#L231), [`GlobalStoreCommitUnconfirmed`](../../../src/genro_asgi_multiworker_spa/global_store.py#L87), [`WorkerHandler`](../../../src/genro_asgi_multiworker_spa/orchestration/worker_handler.py#L209).

## Source and test evidence

- [Global store client and lease](../../../src/genro_asgi_multiworker_spa/global_store.py)
- [Commander store operations](../../../src/genro_asgi_multiworker_spa/orchestration/spa_commander.py)
- [Worker death cleanup](../../../src/genro_asgi_multiworker_spa/orchestration/worker_handler.py)
