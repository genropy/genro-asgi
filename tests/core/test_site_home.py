...
from genro_asgi import AsgiServer, SiteHome
...
class TestTheInstallationRootInFiveContexts:
    ...
    contexts = {
        "development": "{tmp}/home/developer/.genroasgi",
        "classic production": "{tmp}/srv/genro/.genroasgi",
        "virtualenv": "{tmp}/srv/shop/.venv/.genroasgi",
        "docker": "{tmp}/opt/genroasgi",
        "kubernetes": "{tmp}/mnt/genroasgi",
    }
    ...
    def test_each_context_is_one_value_of_the_variable(
        ...
        for spelling in self.contexts.values():
            ...
            monkeypatch.setenv("GENRO_ASGI_HOME", root)
    ...
    def test_the_explicit_argument_wins_over_the_variable(
        ...
        monkeypatch.setenv("GENRO_ASGI_HOME", str(tmp_path / "from-the-environment"))
    ...
    def test_without_the_variable_the_user_home_answers(
        ...
        monkeypatch.delenv("GENRO_ASGI_HOME", raising=False)
...
class TestConfigureWritesTheCardAndTheHome:
    ...
    def test_every_option_given_runs_without_a_question(self, tmp_path: Path) -> None:
        ...
        assert configure(
            ...
            [
                ...
                "--home", str(home),
                "--template", "default",
                "--applications", "genro_asgi.application:BaseApplication",
                "--host", "0.0.0.0",
                "--port", "8100",
            ],
        ) == 0
    ...
    def test_the_site_home_cannot_be_the_installation_root(self, tmp_path: Path) -> None:
        cli = Cli(registry=SitesRegistry(base_dir=tmp_path / "root"))
        with pytest.raises(CliError, match="cannot be the genro-asgi home"):
