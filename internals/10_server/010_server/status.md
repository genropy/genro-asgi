...
Claim anchors: [`BaseServer`](../../../src/genro_asgi/server.py#L86), [`WorkPool`](../../../src/genro_asgi/pool.py#L41), [`Lifespan`](../../../src/genro_asgi/lifespan.py#L89), [`RequestRegistry`](../../../src/genro_asgi/request_registry.py#L124), [`register_application`](../../../src/genro_asgi/server.py#L179), [`AsgiServer`](../../../src/genro_asgi/asgi_server.py#L91).
...
Claim anchors: [`BaseServer`](../../../src/genro_asgi/server.py#L86), [`demux`](../../../src/genro_asgi/server.py#L325), [`RequestRegistry`](../../../src/genro_asgi/request_registry.py#L124), [`current`](../../../src/genro_asgi/request_registry.py#L144), [`WorkPool`](../../../src/genro_asgi/pool.py#L41).
...
Claim anchors: [`on_websocket`](../../../src/genro_asgi/server.py#L365), [`send_message`](../../../src/genro_asgi/server.py#L248).
...
Claim anchors: [`Lifespan`](../../../src/genro_asgi/lifespan.py#L89), [`FatalBootError`](../../../src/genro_asgi/lifespan.py#L78), [`lifespan`](../../../src/genro_asgi/server.py#L208), [`BaseServer`](../../../src/genro_asgi/server.py#L86), [`shutdown_timeout_seconds`](../../../src/genro_asgi/server.py#L402), [`AsgiServer`](../../../src/genro_asgi/asgi_server.py#L91).

Behavior evidence: [`startup`](../../../src/genro_asgi/lifespan.py#L116), [`shutdown`](../../../src/genro_asgi/lifespan.py#L121), [`_run_hook`](../../../src/genro_asgi/lifespan.py#L147).
...
- [src/genro_asgi/pool.py](../../../src/genro_asgi/pool.py)
- [src/genro_asgi/request_registry.py](../../../src/genro_asgi/request_registry.py)
